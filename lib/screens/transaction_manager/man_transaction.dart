                                                                      ...
                                                                      return ListTile(
                                                                        ...
                                                                        leading:
                                                                          ...
                                                                          backgroundColor:
                                                                              Color(_color),
                                                                          child: Icon(
                                                                              expenseCategories.values.toList()[index],
                                                                              color: Colors.white),
                                                                        ),
                                                                        onTap:
                                                                            () {
                                                                ...
                                                                : ListView
                                                                    ...
                                                                    itemBuilder:
                                                                        (context,
                                                                            index) {
                                                                      return ListTile(
                                                                          title: Text(incomeCategories.keys.toList()[
                                                                              index]),
                                                                          contentPadding: EdgeInsets.only(
                                                                              left:
                                                                                  0.0,
                                                                          ...
                                                                          leading:
                                                                            ...
                                                                            backgroundColor:
                                                                                Color(_color),
                                                                            child:
                                                                                Icon(incomeCategories.values.toList()[index], color: Colors.white),
                                                                          ),
                                                                          onTap:
                                                                              () {
                                                                            setState(() {
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Focus(
                              ...
                              final bool hasFocus = focusNode.hasFocus;
                              return TextFormField(
                                  initialValue: _currentTransaction.value.note,
                                  style: textStyle(hasFocus, _color),
                                  decoration:
